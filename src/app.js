...
import StudentsExtendModel from './routes/custom/students.extend.router.js'

//Declarando Express para usar sus funciones.
const app = express();
const studentExtend = new StudentsExtendModel()
...
app.use("/api/extend/users", studentExtend.getRouter())
